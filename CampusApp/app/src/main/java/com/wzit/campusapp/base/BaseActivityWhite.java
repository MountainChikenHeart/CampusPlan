...
import com.wzit.campusapp.activity.MainActivity;
 ...
 * activity基类
 */
public abstract class BaseActivityWhite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        hideStatusBar();
        SetTitleBarFontColor(activity);
        //设置底部导航栏颜色
        StatusBarUtils.setNavigationBarColor(this, Color.parseColor("#ffffff"));
    }
